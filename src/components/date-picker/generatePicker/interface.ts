...
import type { Locale as RcPickerLocale } from "../../rc-picker/interface";
...
import type { Variant } from "../../form/hooks/useVariants"; // import type { Variant } from "../../form/hooks/useVariants";
import type { TimePickerLocale } from "../../time-picker"; // import type { TimePickerLocale } from "../../time-picker";

const DataPickerPlacements = [
  "bottomLeft",
  "bottomRight",
  "topLeft",
  "topRight",
...
export type RangePickerProps<DateType extends AnyObject = any> =
  InjectDefaultProps<RcRangePickerProps<DateType>>;
