...
import { RangePicker as RCRangePicker } from "../PickerInput/RangePicker";
...
export default function generateRangePicker<DateType extends AnyObject>(
  ...
  const RangePicker = forwardRef<PickerRef, DateRangePickerProps>(
    (props, ref) => {
      const {
      ...
      const { getPrefixCls, direction, getPopupContainer, rangePicker } =
