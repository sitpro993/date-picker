...
import dayjsGenerateConfig from "../rc-picker/generate/dayjs";
...
export type DatePickerProps<ValueType = Dayjs | Dayjs> =
...
function postPureProps(props: DatePickerProps) {
  const dropdownAlign = transPlacement2DropdownAlign(
    props.direction,
    props.placement
  );
...
(DatePicker as DatePickerType)._InternalPanelDoNotUseOrYouWillBeFired =
  PurePanel;
...
(DatePicker as DatePickerType)._InternalRangePanelDoNotUseOrYouWillBeFired =
  PureRangePanel;
