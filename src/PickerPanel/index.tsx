...
function PickerPanel<DateType extends object = any>(
  ...
  const mergedPrefixCls =
    React.useContext(PickerContext)?.prefixCls || prefixCls || "rc-picker";
  ...
  const [timeProps, localeTimeProps, showTimeFormat, propFormat] =
    getTimeProps(props);
  ...
  if (process.env.NODE_ENV !== "production") {
    warning(
      !mergedValue ||
        mergedValue.every((val) => generateConfig.isValidate(val)),
